...
import { ArrowRight, Home, Star, CreditCard, Heart, Shield } from 'lucide-react';
...
const BecomeHost = () => {
  ...
  const calculateEarnings = () => {
    ...
    const pricingData = locationPricing[location] || { basePrice: 80, bedroomMultiplier: 1 };
    ...
    <div className="min-h-screen bg-gray-100">
        ...
        <div className=" z-10">
          ...
          >
            ...
            <p className="text-xl text-white md:text-2xl text-center mb-8">
              Join thousands of hosts who are earning by sharing their homes, apartments, and unique spaces on FlapaBay.
            </p>
            <div className="flex flex-wrap pt-6 md:pt-0 justify-center gap-4">
              <Button size="lg" className="bg-flapabay-yellow bg-[#ffc500] text-white text-lg hover:bg-flapabay-yellow/90">
                Become a Host <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
              <Button size="lg" variant="outline" className="bg-transparent border-white text-white hover:bg-white/20 text-lg">
                Learn More
              </Button>
            </div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 bg-white rounded-2xl shadow-md overflow-hidden">
            <div className="lg:col-span-3 p-8 md:p-12">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-flapabay-lightGray rounded-xl p-6">
                  <label className="block text-sm font-medium mb-2">What type of place will you host?</label>
                  <select 
                    value={placeType}
                ...
                <div className="bg-flapabay-lightGray rounded-xl p-6">
                  <label className="block text-sm font-medium mb-2">How many guests can your place accommodate?</label>
            ...
            <div className="lg:col-span-2 bg-flapabay-yellow p-8 md:p-12 flex flex-col justify-center">
              <div className="mb-8">
                <h3 className="text-3xl font-bold mb-2">${estimatedEarnings.monthly}</h3>
                <p className="text-lg text-black/80">Est. monthly earnings</p>
                {location && (
                  <div className="mt-2 flex flex-col">
                    <p className="text-md text-black/90">
                      <span className="font-semibold">${estimatedEarnings.nightly}</span> per night
                    </p>
                    <p className="text-sm text-black/70">
                      Based on {estimatedEarnings.occupancyRate}% occupancy in {location}
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-black/80">Your area is popular with travelers right now</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-lg">Get paid quickly</h4>
                    <p className="text-black/80">Payments are sent 24 hours after guest check-in</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-lg">FlapaBay has you covered</h4>
                    <p className="text-black/80">Get $1M in damage protection and liability insurance</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {[
              {
                ...
                description: "It's free and easy to set up your listing on FlapaBay. Describe your space, how many guests you can accommodate, and add photos.",
                icon: Home
              },
              {
                step: "2",
                title: "Welcome your first guests",
                description: "Once your listing is live, qualified guests can reach out. You can message them and set your own house rules.",
                icon: Heart
              },
              {
                step: "3",
                title: "Start earning",
                description: "When your space is booked, we'll send you payments automatically. You can track earnings and bookings from your dashboard.",
                icon: CreditCard
              }
            ].map((item, index) => {
      ...
      <section className="py-20 max-w-6xl mx-auto bg-flapabay-lightGray">
        <div className="flapabay-container">
          ...
          >
            ...
            <p className="section-subtitle">
              Join thousands of hosts who have shared their spaces and earned extra income
            </p>
          </motion.div>
            ...
            {[
              {
                name: "Sarah J.",
                location: "Miami, FL",
                quote: "I've been hosting on FlapaBay for 2 years and it has completely changed my financial situation. The extra income helped me renovate my house.",
              ...
              },
              {
                ...
                quote: "The FlapaBay platform is so easy to use. I'm not tech-savvy but I was able to list my apartment and start hosting within a day!",
                image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=774&q=80"
              },
              {
                name: "Elena R.",
                location: "Los Angeles, CA",
                quote: "I was hesitant at first, but the support from FlapaBay has been amazing. Their customer service team helped me set up and optimize my listing.",
              ...
              >
                ...
                <div className="mt-4 flex">
                  {[...Array(5)].map((_, i) => (
                    <Star key={i} className="w-5 h-5 text-flapabay-yellow fill-flapabay-yellow" />
                  ))}
                </div>
              </motion.div>
            ))}
            ...
            {[
              {
                ...
                answer: "To become a host, you need to create a FlapaBay account, verify your identity, provide details about your space, set house rules, and determine your availability and pricing."
              },
              {
                question: "How much does it cost to list my space?",
                answer: "It's completely free to list your space on FlapaBay. We only charge a service fee (typically 3%) when you receive a booking."
              },
              {
                question: "How do I set my own price?",
                answer: "You have full control over your listing price. Our smart pricing tool can help suggest competitive rates based on demand, location, and seasonality, but you can always set your own price."
              },
              {
                question: "How does FlapaBay support hosts?",
                answer: "FlapaBay provides hosts with $1M in damage protection, liability insurance, 24/7 customer support, educational resources, and a host community forum for sharing tips and advice."
              },
              {
                question: "What if I need to cancel a reservation?",
                answer: "While we encourage honoring reservations, we understand that unexpected events happen. You can cancel reservations, but this may affect your Superhost status and availability in search results."
              }
            ].map((faq, index) => (
              <motion.div 
                key={index}
      ...
      <section className="py-20 relative">
        ...
        <div 
          ...
          style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1554995207-c18c203602cb?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80)' }}
        ></div>
        <div className="flapabay-container relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Button size="lg" className="bg-flapabay-yellow text-black text-lg hover:bg-flapabay-yellow/90 px-8 py-6">
                Become a Host <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </motion.div>
          </div>
