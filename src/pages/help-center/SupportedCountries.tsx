    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 pt-20">
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              >
                ...
                <Input 
                  ...
                  className="w-full py-6 pl-12 pr-4 text-lg rounded-full shadow-md focus:outline-none focus:ring-2 focus:ring-black"
                  value={searchTerm}
        ...
        <section className="py-16 bg-white">
          <div className="flapabay-container">
            <Tabs defaultValue="africa" className="w-full">
              <TabsList className="justify-start w-full mb-8 overflow-x-auto flex-nowrap whitespace-nowrap">
                      ...
                      >
                        <CardContent className="flex items-center p-4">
                          {comingSoon.includes(country) ? (
                            <Clock className="flex-shrink-0 w-5 h-5 mr-3 text-gray-400" />
                          ) : (
        ...
        <section className="py-16 bg-gray-50">
          <div className="flapabay-container">
            <h2 className="mb-12 text-2xl font-bold text-center">Currency & Language Support</h2>
            
            <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
              <Card className="shadow-sm">
                <CardContent className="p-6">
                  <h3 className="mb-4 text-xl font-semibold">Supported Currencies</h3>
              ...
              <Card className="shadow-sm">
                <CardContent className="p-6">
                  <h3 className="mb-4 text-xl font-semibold">Supported Languages</h3>
                  <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
                    {[
        ...
        <section className="py-16 bg-white">
          <div className="flapabay-container">
            <h2 className="mb-8 text-2xl font-bold text-center">Regional Support Centers</h2>
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                <Card key={index} className="shadow-sm">
                  <CardContent className="p-6">
                    <h3 className="mb-2 text-xl font-semibold">{center.region}</h3>
                    <p className="mb-4 text-gray-600">{center.location}</p>
                    ...
                    <div className="space-y-2">
                      ...
                      <div>
                        ...
                        <span className="ml-2 text-sm text-gray-600">{center.hours}</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
